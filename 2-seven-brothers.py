...
#
# "Seitsemän veljestä" is one of the first novels ever written in Finnish. It is the
# story of seven orphaned brothers learning to make their way in the world (read
# more on Wikipedia).
#
